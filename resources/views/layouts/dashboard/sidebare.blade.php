<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#maintainers" data-bs-toggle="collapse" href="#">
                <i class="bi bi-menu-button-wide"></i><span>Maintainers</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="maintainers" class="nav-content collapse " data-bs-parent="#sidebar-nav">

                <li>
                    <a href="@route('maintainer.index')">
                        <i class="bi bi-circle"></i><span>Maintainers</span>
                    </a>
                </li>
                <li>
                    <a href="@route('maintainer.create')">
                        <i class="bi bi-circle"></i><span>Create Maintainers</span>
                    </a>
                </li>
            </ul>
        </li><!-- End tenant Nav -->
